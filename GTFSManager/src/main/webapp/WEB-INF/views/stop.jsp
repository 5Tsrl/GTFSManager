...
<body>
	...
	<div class="col-lg-4">
		<c:if test="${not empty lineaAttiva.gtfsId && not empty corsaAttiva.gtfsId}">
			<a class="btn btn-default" href="/_5t/fermateCorse">Assegna fermate alla corsa ${corsaAttiva.gtfsId}</a>
		</c:if>
	</div>
